...
bot_token = os.environ.get("BOT_TOKEN", "5974054493:AAFTQvELK38jPc5p1JBRN5ZuUlTTbUmcFT4")
# =========================================================== #

db_url = os.environ.get("DB_URL", "mongodb+srv://neko:<password>@nekomenfess.o2l1gsr.mongodb.net/?retryWrites=true&w=majority")
